...
//
// parseWorkflowOn / githubFilterMatches / workflowFiresOnTag live in tools/lib/workflow-triggers.js
// (#338) — shared with `colab release cut`, imported near the top of this file.
...
// The logic lives in tools/lib/workflow-triggers.js (#338) so `colab release cut` refuses on the
// same finding; this maps its severity onto the audit's fail/warn.
function checkPrereleaseTagTrigger(src, workflows, deploy, fail, warn) {
